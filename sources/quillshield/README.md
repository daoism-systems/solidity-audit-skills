...
> **Library mirror note:** this repository's mirror of quillshield carries 5
> plugins, not upstream's 10. The semantic-guard-analysis,
> state-invariant-detection, oracle-flashloan-analysis, external-call-safety
> and signature-replay-analysis plugins were merged into this library's
> symbiosis collection (`../symbiosis/`) — each merged with its overlapping
> counterpart from the pashov and plamen mirrors — and dispatch from there.
> Upstream QuillShield remains the source of truth for the original
> methodology.
...
```
             ...
             │    Guard Analysis      │ │  Layer 5: Proxy/Upgrade    │
             │    (symbiosis)         │ │  Layer 6: Input/Arithmetic │
             │  Layer 2: State        │ │  Layer 9: DoS/Griefing     │
             │    Invariant Detection │ │                            │
             │    (symbiosis)         │ │  Layers 4/7/8 merged into  │
             │                        │ │  symbiosis as well         │
             └────────────────────────┘ └────────────────────────────┘
```
...
|----------------|-------------------|----------|
| SC01: Access Control | Semantic Guard Analysis (symbiosis guard-consistency) | Full |
| SC02: Oracle Manipulation | Oracle & Flash Loan Analysis (symbiosis oracle-flashloan-analysis) | Full |
| SC03: Logic Errors | BSA + State Invariant Detection (symbiosis invariant-conservation) | Full |
| SC04: Input Validation | Input & Arithmetic Safety | Full |
| SC05: Reentrancy | Reentrancy Pattern Analysis | Full |
| SC06: Unchecked External Calls | External Call Safety (symbiosis external-call-safety) | Full |
| SC07: Flash Loan Attacks | Oracle & Flash Loan Analysis (symbiosis oracle-flashloan-analysis) | Full |
...
| Signature Replay Attacks | Signature & Replay Analysis (symbiosis signature-replay) |
| Token Integration (Weird ERC20) | External Call Safety (symbiosis external-call-safety) |
| MEV/Frontrunning | Oracle & Flash Loan Analysis (symbiosis oracle-flashloan-analysis) |
